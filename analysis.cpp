...
//    lines = words.size();
//    auto one = [&](std::promise<std::map<char, float>> p) {
//        p.set_value(calculate_weight(first));
//    };
//
//    auto two = [&](std::promise<std::map<char, float>> p) {
//        p.set_value(calculate_weight(second));
//    };
//
//    auto three = [&](std::promise<std::map<char, float>> p) {
//        p.set_value(calculate_weight(third));
//    };
//
//    auto four = [&](std::promise<std::map<char, float>> p) {
//        p.set_value(calculate_weight(fourth));
//    };
//
//    auto five = [&](std::promise<std::map<char, float>> p) {
